...
Учебный pipeline: скачивание статистики с API грейдера, разбор `passback_params`, валидация и загрузка в локальную PostgreSQL с записью стадий в лог. После успешной вставки в БД считаются дневные метрики, выгружаются в Google Sheets и уходит email на mail.ru. 
